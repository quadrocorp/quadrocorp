...
- Самостоятельной разработке проектов
- Изучении best practices и современных технологий
- Участии в открытых проектах и сообществах
...
|-----------|------------|
| **Языки программирования** | JavaScript, TypeScript, Python, Go, SQL, 1C (изучаю) |
| **Frontend** | React, Tailwind CSS, Next.js (изучаю) |
...
### 🎨 Цифровое творчество
- **3D моделирование и текстурирование:** Blender, Cinema 4D, Adobe Substance Painter
- **Архитектура и инженерия:** ArchiCAD, SketchUp, Autodesk AutoCAD
- **2D дизайн и концепт-арт:** Adobe Photoshop, Illustrator, Krita, Easy Paint Tool SAI, CLIP Studio Paint

### 🎵 Музыка и аудио
- **Аудио дизайн и композиция:** Kontakt, Guitar Rig
- **Плагины:** Fabfilter, Izotope, ValhallaDSP, Soundtoys
- **DAW:** FL Studio
- **Нотация:** MuseScore Studio

### ✍️ Писательство
- **Инструменты:** Obsidian, Fade In, ScenaristKit
- Жанры: техническая документация, творческое письмо
...
- Actively studying programming and software development
- Self-directed learning through practical projects
...
- Learning best practices and modern technologies
...
|----------|--------------|
| **Programming Languages** | JavaScript, TypeScript, Python, Go, SQL, 1C (learning) |
...
### 🎨 Digital Creativity
- **3D Modeling & Texturing:** Blender, Cinema 4D, Adobe Substance Painter
- **Architecture & Engineering:** ArchiCAD, SketchUp, Autodesk AutoCAD
- **2D Design & Concept Art:** Adobe Photoshop, Illustrator, Krita, Easy Paint Tool SAI, CLIP Studio Paint

### 🎵 Music & Audio
- **Audio Design & Composition:** Kontakt, Guitar Rig
- **Plugins:** Fabfilter, Izotope, ValhallaDSP, Soundtoys
- **DAW:** FL Studio
- **Notation:** MuseScore Studio

### ✍️ Writing
- **Tools:** Obsidian, Fade In, ScenaristKit
- Genres: Technical documentation, creative writing
